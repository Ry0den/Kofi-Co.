...
public class View_Order {
    ...
    public void CardLayout() {
        setupHeaderPanel();
        populateOrders();  // Make sure orders are populated initially
        BottomHeader();
        upper();
        ...
        // Add listener to refresh when panel is shown
    ...
    public void setCardLayout(CardLayout layout, JPanel panel) {
        ...
        // Add a listener to refresh orders when the panel is shown
        mainPanel.addComponentListener(new java.awt.event.ComponentAdapter() {
            public void componentShown(java.awt.event.ComponentEvent e) {
                populateOrders();
                double totalPrice = calculateTotalPrice();
        ...
        // Also add listener to the card panel
